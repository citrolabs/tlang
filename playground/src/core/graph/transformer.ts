 ...
 *
 * Single source of truth: Auto-extracted from tlang/src/index.ts
 */
function extractImports(nodes: GraphNode[]): { namespaces: Set<string>; topLevelTypes: Set<string> } {
  ...
  // Auto-generated by scripts/bundle-tlang-sources.js
...
/**
 * Generate tlang TypeFlow type definition from graph
 */
export function generateTLangCode(
  ...
  // Always include TypeFlow, Exec, Out for DAG execution
  ...
  const typeImports = ['TypeFlow', 'Exec', 'Out', ...topLevelList, ...namespaceList]
